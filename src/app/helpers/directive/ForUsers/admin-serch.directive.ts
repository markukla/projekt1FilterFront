...
@Directive({
  selector: '[appSearchAdmins]'
})
export class AdminSerchDirective {
  @Input('appSearchAdmins') searchedArray: Array<any>;
...
// tslint:disable-next-line:typedef
  serchTable() {
    this.usersBackendService.getAllAdmins().subscribe((users) => {
