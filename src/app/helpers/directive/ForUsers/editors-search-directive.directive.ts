...
@Directive({
  selector: '[appEditorsSearchDirective]'
})
export class EditorsSearchDirectiveDirective {
  @Input('appEditorsSearchDirective') searchedArray: Array<any>;
...
// tslint:disable-next-line:typedef
  serchTable() {
    this.usersBackendService.getAllEditors().subscribe((users) => {
